...
void setup() {
  pinMode(hcf_a, OUTPUT);
  digitalWrite(hcf_a, LOW);
  delay(1000);
  Serial.begin(115200);
  connectwifi();
...
void senddata(int x, int y) {
    ...
    String httpRequestData = "api_key=" + apiKeyValue +"&humidity="+h +"&solar="+i;
    Serial.print("httpRequestData: ");

                                
    Link = "/solar/post-esp-data.php?"+httpRequestData;  //
    Serial.print("Link = ");
    Serial.println(Link);
    postdata();
  }
